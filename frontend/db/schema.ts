...
export const knowledge = pgTable(
  ...
  (table) => [
    index("idx_knowledge_user_updated_at").using(
      "btree",
...
export const file = pgTable(
  ...
  (table) => [
    index("idx_file_hash")
      .using("btree", table.hash.asc().nullsLast().op("text_ops"))
      .where(sql`(hash IS NOT NULL)`),
    index("idx_file_user_created_at").using(
      "btree",
      table.userId.asc().nullsLast().op("timestamptz_ops"),
...
export const chat = pgTable(
  ...
  (table) => [
    index("idx_chat_user_folder_updated_at").using(
      "btree",
      table.userId.asc().nullsLast().op("timestamptz_ops"),
      table.folderId.asc().nullsLast().op("timestamptz_ops"),
      table.updatedAt.desc().nullsFirst().op("timestamptz_ops"),
    ),
    index("idx_chat_user_pinned_updated_at")
      .using(
        "btree",
        table.userId.asc().nullsLast().op("uuid_ops"),
        table.updatedAt.desc().nullsFirst().op("timestamptz_ops"),
      )
      .where(sql`(pinned IS TRUE)`),
    index("idx_chat_user_updated_at").using(
      "btree",
      table.userId.asc().nullsLast().op("timestamptz_ops"),
...
export const chatMessage = pgTable(
  ...
  (table) => [
    index("idx_chat_message_chat_created_at").using(
      "btree",
      table.chatId.asc().nullsLast().op("timestamptz_ops"),
      table.createdAt.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_chat_message_chat_parent").using(
      "btree",
      table.chatId.asc().nullsLast().op("uuid_ops"),
      table.parentId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_chat_message_created_at").using(
      "btree",
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("idx_chat_message_model_created_at").using(
      "btree",
      table.modelId.asc().nullsLast().op("timestamptz_ops"),
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
    index("idx_chat_message_user_created_at").using(
      "btree",
      table.userId.asc().nullsLast().op("timestamptz_ops"),
      table.createdAt.asc().nullsLast().op("timestamptz_ops"),
    ),
...
export const knowledgeFile = pgTable(
  ...
  (table) => [
    index("idx_knowledge_file_file_id").using(
      "btree",
      table.fileId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_knowledge_file_user_id").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
    ...
    unique("uq_knowledge_file_knowledge_file").on(
      table.knowledgeId,
      table.fileId,
    ),
  ],
...
export const chatFile = pgTable(
  ...
  (table) => [
    index("idx_chat_file_file_id").using(
      "btree",
      table.fileId.asc().nullsLast().op("uuid_ops"),
    ),
    index("idx_chat_file_message_id")
      .using("btree", table.messageId.asc().nullsLast().op("uuid_ops"))
      .where(sql`(message_id IS NOT NULL)`),
    index("idx_chat_file_user_id").using(
      "btree",
      table.userId.asc().nullsLast().op("uuid_ops"),
    ),
    foreignKey({
